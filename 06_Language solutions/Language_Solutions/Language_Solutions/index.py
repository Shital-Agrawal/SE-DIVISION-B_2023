...
def start_main_page():
    ...
    def option():
        ...
        sel_btn1.grid(row=0, column=7, pady=(10, 0), padx=50, )
        sel_btn2.grid(row=1, column=7, pady=(10, 0), padx=50, )
        sel_btn3.grid(row=2, column=7, pady=(10, 0), padx=50, )
        sel_btn4.grid(row=3, column=7, pady=(10, 0), padx=50, )
        sel_btn5.grid(row=4, column=7, pady=(10, 0), padx=50, )
        sel_btn6.grid(row=5, column=7, pady=(10, 0), padx=50, )
        sel_btn7.grid(row=6, column=7, pady=(10, 0), padx=50, )
    ...
    main_window.geometry("1000x626+160+50")
